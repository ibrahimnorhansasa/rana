...
<body>
    ...
    <main>
        ...
        <section class="py-5 text-center container">
            <div class="row col-md-10 m-auto">
                @if($post->image !=null)
                <img src="{{asset('public/assets/images/posts/'.$post->image)}}" alt="Post Image" style="height:400px;">
                ...
                <div class="blog-card">
                    <div class="blog-card-body">
                        ...
                        <p class="blog-card-text">{{$post->text}}.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <h3>مقالات متشابهة</h3><br>
        <div class="row">
            @foreach($randomPosts as $po)
            <div class="col-md-4">
                <div class="card mb-3" style="width:400px;border-radius:50px">
                    @if($po->image !=null)
                    <img src="{{asset('public/assets/images/posts/'.$po->image)}}" alt="Post Image" style="height:300px;
                        border-top-left-radius: 50px;border-top-right-radius: 50px;" class="card-img-top">

                    @else
                    <p style="height:300px"></p>
                    @endif
                    <div class="card-body"
                        style="background:#E75F47;color:#fff;border-bottom-left-radius: 50px;border-bottom-right-radius: 50px;" ">
                     <h4 class=" card-title">{{$po->title}}</h4>
                        <p class="card-text">{{$po->date}}.</p>
                    </div>
                </div>
            </div>
            @endforeach
